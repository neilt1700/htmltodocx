...
* Anything still remaining after a stop to be returned as is (with any tags filtered out).
* 
...
function h2d_html_allowed_children($tag = NULL) {
  ...
  $allowed_children = array(
    ...
    'p' => array('a', 'em', 'i', 'strong', 'b', 'ul', 'ol', 'img', 'table', 'br', 'span', 'u', 'sup', 'text', 'div', 'p'), // p does not nest - simple_html_dom will create a flat set of paragraphs if it finds nested ones. NB cannot have a table nested in a table element (PHPWord)
